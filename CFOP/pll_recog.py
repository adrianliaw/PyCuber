...
def Aa_recog(cube):
	return recog_pattern(cube, L=[(4, 0), (0, 1), (0, 2)], F=[(2, 0), (2, 1), (4, 2)], R=[(5, 0), (4, 1), (5, 2)], B=[(0, 0), (5, 1), (2, 2)])

def Ab_recog(cube):
	return recog_pattern(cube, L=[(5, 0), (0, 1), (0, 2)], F=[(2, 0), (2, 1), (5, 2)], R=[(0, 0), (4, 1), (2, 2)], B=[(4, 0), (5, 1), (4, 2)])
