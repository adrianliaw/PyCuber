...
THREE.BeveledBlockGeometry=function(e,t,n,r,i,s,o){"use strict";function g(e,t,n,r,i,s,o,a){var f,l,c,h=u.widthSegments,p=u.heightSegments,d=i/2,v=s/2,m=u.vertices.length;if(e==="x"&&t==="y"||e==="y"&&t==="x"){f="z"}else if(e==="x"&&t==="z"||e==="z"&&t==="x"){f="y";p=u.depthSegments}else if(e==="z"&&t==="y"||e==="y"&&t==="z"){f="x";h=u.depthSegments}var g=h+1,y=p+1,b=i/h,w=s/p,E=new THREE.Vector3;E[f]=o>0?1:-1;for(c=0;c<y;c++){for(l=0;l<g;l++){var S=new THREE.Vector3;S[e]=(l*b-d)*n;S[t]=(c*w-v)*r;S[f]=o;u.vertices.push(S)}}for(c=0;c<p;c++){for(l=0;l<h;l++){var x=l+g*c;var T=l+g*(c+1);var N=l+1+g*(c+1);var C=l+1+g*c;var k=new THREE.Face4(x+m,T+m,N+m,C+m);k.vertexNormals.push(E.clone(),E.clone(),E.clone(),E.clone());k.materialIndex=a;u.faces.push(k);u.faceVertexUvs[0].push([new THREE.Vector2(l/h,1-c/p),new THREE.Vector2(l/h,1-(c+1)/p),new THREE.Vector2((l+1)/h,1-(c+1)/p),new THREE.Vector2((l+1)/h,1-c/p)])}}}function y(e,t,n,r,i,s,o,a,f,l,c,h,p){var d;var v=u.vertices.length;d=new THREE.Vector3(t,n,r);u.vertices.push(d);if(e==="x"){d=new THREE.Vector3(t,s,o);u.vertices.push(d);d=new THREE.Vector3(i,s,o);u.vertices.push(d);d=new THREE.Vector3(i,n,r);u.vertices.push(d)}else if(e==="y"){d=new THREE.Vector3(i,n,o);u.vertices.push(d);d=new THREE.Vector3(i,s,o);u.vertices.push(d);d=new THREE.Vector3(t,s,r);u.vertices.push(d)}else{d=new THREE.Vector3(i,s,r);u.vertices.push(d);d=new THREE.Vector3(i,s,o);u.vertices.push(d);d=new THREE.Vector3(t,n,o);u.vertices.push(d)}var m=new THREE.Face4(v,v+1,v+2,v+3);var g=new THREE.Vector3(a,f,l);var y=new THREE.Vector3(c,h,p);m.vertexNormals.push(g.clone(),y.clone(),y.clone(),g.clone());m.materialIndex=0;u.faces.push(m);u.faceVertexUvs[0].push([new THREE.Vector2(0,0),new THREE.Vector2(0,1),new THREE.Vector2(1,1),new THREE.Vector2(1,0)])}function b(e,t,n,r,i,s){var o;var a=u.vertices.length;var f=0;for(var l=0;l<2;l++){var c=l?1:-1;for(var h=0;h<2;h++){var p=h?1:-1;for(var d=0;d<2;d++){var v=d?1:-1;o=new THREE.Vector3(c*t,p*n,v*i);u.vertices.push(o);var m=new THREE.Vector3(c,0,0);o=new THREE.Vector3(c*e,p*r,v*i);u.vertices.push(o);var g=new THREE.Vector3(0,p,0);o=new THREE.Vector3(c*e,p*n,v*s);u.vertices.push(o);var y=new THREE.Vector3(0,0,v);var b;b=new THREE.Face3(a,a+1,a+2);if(c*p*v===1){b=new THREE.Face3(a,a+1,a+2);b.vertexNormals.push(m,g,y)}else{b=new THREE.Face3(a+2,a+1,a);b.vertexNormals.push(y,g,m)}b.materialIndex=0;u.faces.push(b);u.faceVertexUvs[0].push([new THREE.Vector2(0,0),new THREE.Vector2(0,1),new THREE.Vector2(1,1)]);a+=3;f++}}}}THREE.Geometry.call(this);var u=this;this.width=e;this.height=t;this.depth=n;this.bevel=r||0;this.widthSegments=i||1;this.heightSegments=s||1;this.depthSegments=o||1;var a=this.width/2;var f=this.height/2;var l=this.depth/2;var c=this.width-this.bevel*2;var h=this.height-this.bevel*2;var p=this.depth-this.bevel*2;if(p>0&&h>0){g("z","y",-1,-1,p,h,a,0);g("z","y",1,-1,p,h,-a,0)}if(c>0&&p>0){g("x","z",1,1,c,p,f,0);g("x","z",1,-1,c,p,-f,0)}if(c>0&&h>0){g("x","y",1,-1,c,h,l,0);g("x","y",-1,-1,c,h,-l,0)}if(this.bevel>0){if(c<0){c=0}if(h<0){h=0}if(p<0){p=0}var d=c/2;var v=h/2;var m=p/2;y("x",-d,-f,-m,d,-v,-l,0,-1,0,0,0,-1);y("x",d,-f,m,-d,-v,l,0,-1,0,0,0,1);y("z",-d,-f,m,-a,-v,-m,0,-1,0,-1,0,0);y("z",d,-f,-m,a,-v,m,0,-1,0,1,0,0);y("x",d,f,-m,-d,v,-l,0,1,0,0,0,-1);y("x",-d,f,m,d,v,l,0,1,0,0,0,1);y("z",-d,f,-m,-a,v,m,0,1,0,-1,0,0);y("z",d,f,m,a,v,-m,0,1,0,1,0,0);y("y",-a,v,-m,-d,-v,-l,-1,0,0,0,0,-1);y("y",-a,-v,m,-d,v,l,-1,0,0,0,0,1);y("y",a,-v,-m,d,v,-l,1,0,0,0,0,-1);y("y",a,v,m,d,-v,l,1,0,0,0,0,1);b(d,a,v,f,m,l)}this.computeCentroids();this.computeFaceNormals();this.mergeVertices()};THREE.BeveledBlockGeometry.prototype=Object.create(THREE.Geometry.prototype)
