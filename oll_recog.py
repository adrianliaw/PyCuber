...
This module is to recognize all the OLL patterns.
Every recognize function is named by "O--_recog", 
take a cube as an input, return True if it is the O-- pattern, False otherwise.
